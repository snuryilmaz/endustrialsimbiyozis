...
# ----------- ANA İÇERİK GÖSTERİM FLAG'i -----------
show_main_sections = True

# ----------- OPTİMİZASYON & DİYAGRAM ---------
    ...
    if 'uygulama_butonu' in locals() and uygulama_butonu:
        if atik_turu is None:
            ...
            if sonuc is None or toplam_alinan == 0:
                ...
                show_main_sections = False  # Eşleşme olduysa üst metin/video kaldırılır
...
# ----------- ŞEBEKE GRAFİĞİ (sadece eşleşme olduğunda) -----------
if not show_main_sections and sonuc and toplam_alinan > 0:
